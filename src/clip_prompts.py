...
# ---------------------------------------------------------------------------
ATTR_PHRASES = {
    "5_o_Clock_Shadow": ("noun", ["a five o'clock shadow", "light stubble", "a faint beard shadow", "short stubble on the face"]),
    "Arched_Eyebrows": ("noun", ["arched eyebrows", "curved eyebrows", "highly arched brows"]),
    "Attractive": ("adj", ["attractive", "good looking", "beautiful"]),
    "Bags_Under_Eyes": ("noun", ["bags under the eyes", "puffy under-eyes", "eye bags"]),
    "Bald": ("adj", ["bald", "hairless on the head", "with no hair"]),
    "Bangs": ("noun", ["bangs", "a fringe of hair over the forehead", "hair covering the forehead"]),
    "Big_Lips": ("noun", ["big lips", "full lips", "large lips"]),
    "Big_Nose": ("noun", ["a big nose", "a large nose", "a prominent nose"]),
    "Black_Hair": ("noun", ["black hair", "dark black hair"]),
    "Blond_Hair": ("noun", ["blond hair", "blonde hair", "light golden hair"]),
    "Blurry": ("adj", ["blurry", "out of focus", "unsharp"]),
    "Brown_Hair": ("noun", ["brown hair", "brunette hair"]),
    "Bushy_Eyebrows": ("noun", ["bushy eyebrows", "thick eyebrows", "dense brows"]),
    "Chubby": ("adj", ["chubby", "plump", "round-faced"]),
    "Double_Chin": ("noun", ["a double chin", "a second chin", "extra fold under the chin"]),
    "Eyeglasses": ("noun", ["eyeglasses", "glasses", "spectacles"]),
    "Goatee": ("noun", ["a goatee", "a goatee beard", "a small pointed beard"]),
    "Gray_Hair": ("noun", ["gray hair", "grey hair", "silver hair"]),
    "Heavy_Makeup": ("noun", ["heavy makeup", "a lot of makeup", "thick makeup"]),
    "High_Cheekbones": ("noun", ["high cheekbones", "prominent cheekbones"]),
    "Male": ("noun", ["a male face", "the face of a man", "masculine features"]),
    "Mouth_Slightly_Open": ("noun", ["a slightly open mouth", "lips parted slightly", "a mouth slightly open"]),
    "Mustache": ("noun", ["a mustache", "a moustache", "hair on the upper lip"]),
    "Narrow_Eyes": ("noun", ["narrow eyes", "squinted eyes", "thin eyes"]),
    "No_Beard": ("adj", ["clean-shaven", "without a beard", "with a beardless face"]),
    "Oval_Face": ("noun", ["an oval face", "an oval-shaped face"]),
    "Pale_Skin": ("noun", ["pale skin", "fair skin", "light-toned skin"]),
    "Pointy_Nose": ("noun", ["a pointy nose", "a sharp nose", "a pointed nose"]),
    "Receding_Hairline": ("noun", ["a receding hairline", "a hairline pulled back", "thinning hair at the temples"]),
    "Rosy_Cheeks": ("noun", ["rosy cheeks", "pink cheeks", "flushed cheeks"]),
    "Sideburns": ("noun", ["sideburns", "long sideburns", "hair down the sides of the face"]),
    "Smiling": ("adj", ["smiling", "with a smile", "grinning"]),
    "Straight_Hair": ("noun", ["straight hair", "sleek straight hair"]),
    "Wavy_Hair": ("noun", ["wavy hair", "curly wavy hair"]),
    "Wearing_Earrings": ("noun", ["earrings", "ear jewelry", "studs in the ears"]),
    "Wearing_Hat": ("noun", ["a hat", "a cap on the head", "headwear"]),
    "Wearing_Lipstick": ("noun", ["lipstick", "colored lipstick", "lip color"]),
    "Wearing_Necklace": ("noun", ["a necklace", "a chain around the neck", "neck jewelry"]),
    "Wearing_Necktie": ("noun", ["a necktie", "a tie", "a knotted tie"]),
    "Young": ("adj", ["young", "youthful", "young-looking"]),
}
